...
// FIXME : May be part of set source
...
#define WTAP_MAX_PACKET_SIZE_USBPCAP     134217728
#define WTAP_MAX_PACKET_SIZE_EBHSCR      8388608
...
extern void wtap_set_cb_new_secrets(wtap *wth, wtap_new_secrets_callback_t add_new_secrets);
...
extern gboolean wtap_read(wtap *wth, wtap_rec *rec, Buffer *buf, int *err,
    gchar **err_info, gint64 *offset);

extern gboolean wtap_seek_read(wtap *wth, gint64 seek_off, wtap_rec *rec,
...
extern wtap_compression_type wtap_get_compression_type(wtap *wth);

extern const char *wtap_compression_type_description(wtap_compression_type compression_type);

extern const char *wtap_compression_type_extension(wtap_compression_type compression_type);

extern GSList *wtap_get_all_compression_type_extensions_list(void);
