 ...
 */
extern void register_dissector_table_alias(dissector_table_t dissector_table,
    const char *alias_name);

/** Deregister the dissector table by table name. */
// FIXME: void deregister_dissector_table(const char *name);
...
/* Look for a given string in a given dissector table and, if found, call
   the dissector with the arguments supplied, and return the number of
   bytes consumed, otherwise return 0. */
extern int dissector_try_string_new(dissector_table_t sub_dissectors,
...
/* Given a payload dissector table (type FT_NONE), return the handle of
   ...
   Decode As. */
extern dissector_handle_t dissector_get_payload_handle(
 ...
 */
extern dissector_handle_t dissector_table_get_dissector_handle(dissector_table_t dissector_table, const gchar* short_name);
...
extern dissector_handle_t register_dissector_with_data(const char *name, dissector_cb_t dissector, const int proto, void *cb_data);

/** Deregister a dissector. */
// FIXME: Not supported void deregister_dissector(const char *name);
...
// FIXME: extern void dissect_init(void);

// FIXME: extern void dissect_cleanup(void);
...
// FIXME: void init_dissection(void);

/* Free data structures allocated for dissection. */
// FIXME: void cleanup_dissection(void);
 ...
 */
// FIXME: extern void free_data_sources(packet_info *pinfo);
 ...
 */
// FIXME : void deregister_postdissector(dissector_handle_t handle);
 ...
 */
// FIXME: extern gboolean have_postdissector(void);
 ...
 * by libwireshark itself.
 */
// FIXME: extern void call_all_postdissectors(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree);
